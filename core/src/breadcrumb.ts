import { EVENTTYPES, BREADCRUMBTYPES } from '../../common/index';
import { validateOption, getTimestamp, _support } from '../../utils/src/index';
import { BreadcrumbData, InitOptions } from '../../types/index';
