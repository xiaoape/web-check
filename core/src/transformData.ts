...
import { fromHttpStatus, interceptStr, getTimestamp } from '../../utils/src/index';
import { HTTP_CODE, STATUS_CODE } from '../../common/index';
import { HttpData, ResouceError, ResourceTarget } from '../../types/index';
